...
//            .LeeQueue(YES) // 添加到队列
        ...
        case 12:
        {
            ...
            .LeeContent(@"支持 自定义打开动画配置和关闭动画配置 基于 UIView 动画API支持 自定义打开动画配置和关闭动画配置 基于 UIView 动画API支持 自定义打开动画配置和关闭动画配置 基于 UIView 动画API")
            .LeeAction(@"我知道了", ^{
    ...
    switch (index) {
        ...
        case 0:
        {
            ...
            .LeeAddContent(^(UILabel *label) {
                ...
                label.text = @"删除后将无法恢复, 请慎重考虑删除后将无法恢复, 请慎重考虑删除后将无法恢复, 请慎重考虑删除后将无法恢复, 请慎重考虑删除后将无法恢复, 请慎重考虑";
